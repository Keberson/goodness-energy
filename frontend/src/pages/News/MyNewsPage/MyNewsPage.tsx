import { Card, List, Typography, Tag, Space, Button, Empty, Flex, Popconfirm, App } from "antd";
import { EyeOutlined, CalendarOutlined, EditOutlined, DeleteOutlined, UserOutlined } from "@ant-design/icons";
import { useNavigate } from "react-router-dom";
import { useGetMyNewsQuery, useDeleteNewsMutation } from "@services/api/news.api";
...
const MyNewsPage = () => {
    ...
    const { data, isLoading } = useGetMyNewsQuery();
        ...
        <div style={{ padding: 24, minHeight: "calc(100vh - 48px)" }}>
            <Card style={{ minHeight: "calc(100vh - 96px)" }}>
                ...
                {isLoading ? (
                    ...
                    <Empty description="У вас пока нет новостей" />
                ) : (
                    <List
                        itemLayout="vertical"
                        dataSource={data}
