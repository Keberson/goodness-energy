...
class User(Base):
    ...
    notify_city_news = Column(Boolean, default=True, nullable=False)  # Уведомления о новостях из города
    notify_registrations = Column(Boolean, default=True, nullable=False)  # Уведомления о регистрациях
    notify_events = Column(Boolean, default=True, nullable=False)  # Уведомления о событиях
