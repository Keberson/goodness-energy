...
-- -- Новость 6: Как наука помогает развивать устойчивый туризм?
-- INSERT INTO news (user_id, npo_id, volunteer_id, admin_id, name, annotation, text, type, created_at)
-- VALUES (
--   (SELECT id FROM users WHERE login = 'admin'),
--   NULL,
...
--   'Участники II Международного научно-туристического форума Discover Atom обсудили, как соединить науку, образование и технологии, чтобы сделать путешествия бережными к природе и полезными для развития территорий.',
