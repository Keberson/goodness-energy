...
VALUES (
  ...
  $$<p><strong>🎙 Новый выпуск подкаста «Добро без галстуков»</strong></p>
...
<p style="color: #666; font-size: 14px;">#ДоброБезГалстуков</p>$$,
  'THEME',
  NOW()
);
...
VALUES (
  ...
  $$<p><strong>❤️ Как наука помогает развивать устойчивый туризм?</strong></p>
...
<p style="color: #666; font-size: 14px;">#событие #ГостеприимныеГородаРосатома</p>$$,
  'THEME',
  NOW()
);
