...
-- Новость 5: Новый выпуск подкаста «Добро без галстуков»
INSERT INTO news (user_id, npo_id, volunteer_id, admin_id, name, annotation, text, type, created_at)
VALUES (
  ...
  NULL,
  (SELECT id FROM users WHERE login = 'admin'),
  '🎙 Новый выпуск подкаста «Добро без галстуков»',
  'Гость студии — Елена Крючкова, руководитель направления развития социального капитала и благотворительности компании «Норникель». Поговорим о том, как создаются масштабные социальные проекты и почему волонтёрство — это развитие корпоративной культуры.',
  '<p><strong>🎙 Новый выпуск подкаста «Добро без галстуков»</strong></p><p>Гость студии — <strong>Елена Крючкова</strong>, руководитель направления развития социального капитала и благотворительности компании <a href="https://t.me/nornickel_official" style="color: #1e88e5; text-decoration: none;"><strong>«Норникель»</strong></a>.</p><p><em>«Важно верить в то, что ты делаешь, и видеть результат. Когда ты получаешь удовольствие от работы, разделяешь и транслируешь это — невозможно выгореть»</em>, — делится Елена.</p><p>Поговорим о том, как создаются масштабные социальные проекты, почему волонтёрство — это не просто помощь, а развитие корпоративной культуры, и как большие компании учатся быть по-настоящему человеческими.</p><p><a href="https://vk.com/video-232477963_456239040" style="color: #e91e63; text-decoration: none; font-weight: bold;">Смотрим выпуск здесь 👆</a></p><p><strong>Новости создателей проекта:</strong></p><p>🔵 <a href="https://t.me/corpvolunteers" style="color: #1e88e5; text-decoration: none;">канал Национального совета по корпоративному волонтерству (НСКВ) в Telegram</a></p><p>🔵 <a href="https://vk.com/rosatomdobro" style="color: #1e88e5; text-decoration: none;">сообщество АНО «Энергия развития» в ВК</a></p><p><a href="https://vk.com/dobro_bez_galstukov" style="color: #1e88e5; text-decoration: none; font-weight: bold;">Подписывайтесь на официальное сообщество проекта в ВК!</a></p><p>👌 <a href="https://t.me/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Подписывайтесь на «Энергию Развития»</a> | <a href="https://t.me/boost/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Оставляйте «бусты»</a></p><p style="color: #666; font-size: 14px;">#ДоброБезГалстуков</p>',
  'THEME',
  NOW()
);

-- Новость 1: Как наука помогает развивать устойчивый туризм?
INSERT INTO news (user_id, npo_id, volunteer_id, admin_id, name, annotation, text, type, created_at)
VALUES (
  (SELECT id FROM users WHERE login = 'admin'),
  NULL,
  NULL,
  (SELECT id FROM users WHERE login = 'admin'),
  '❤️ Как наука помогает развивать устойчивый туризм?',
  'Участники II Международного научно-туристического форума Discover Atom обсудили, как наука меняет индустрию путешествий и делает туризм бережным к природе.',
  '<p><strong>❤️ Как наука помогает развивать устойчивый туризм?</strong></p><p>Об этом говорили участники II Международного научно-туристического форума <strong>Discover Atom</strong> на сессии «Устойчивый туризм: как наука меняет индустрию путешествий?».</p><p>Модератором и спикером сессии выступила <strong>Вита Саар</strong>, руководитель направления «Туризм и гостеприимство» <a href="https://энергияразвития.рф/" style="color: #1e88e5; text-decoration: none;"><strong>АНО «Энергия развития»</strong></a> и руководитель программы <a href="https://t.me/visit_atom" style="color: #1e88e5; text-decoration: none;"><strong>«Гостеприимные города Росатома»</strong></a>.</p><p>Эксперты научного, образовательного и туристического сообщества обсудили, как соединить науку, образование и технологии, чтобы сделать путешествия бережными к природе и полезными для развития территорий.</p><p>❤️ А еще в этом году <a href="https://t.me/atommuseum" style="color: #1e88e5; text-decoration: none;"><strong>Музей АТОМ</strong></a> отметил два года! Поздравляем команду с днем рождения и желаем новых ярких проектов и вдохновения!</p><p><strong>О чём говорили участники и какие темы стали ключевыми?</strong> <a href="http://vk.cc/cR3gJr" style="color: #e91e63; text-decoration: none; font-weight: bold;">Читайте в материале на нашем сайте</a>.</p><p>👌 <a href="https://t.me/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Подписывайтесь на «Энергию Развития»</a> | <a href="https://t.me/boost/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Оставляйте «бусты»</a></p><p style="color: #666; font-size: 14px;">#событие #ГостеприимныеГородаРосатома</p>',
  'THEME',
  NOW()
);

-- Новость 2: Менторская гостиная на «Созидателях»
INSERT INTO news (user_id, npo_id, volunteer_id, admin_id, name, annotation, text, type, created_at)
VALUES (
  (SELECT id FROM users WHERE login = 'admin'),
  NULL,
  NULL,
  (SELECT id FROM users WHERE login = 'admin'),
  '⚡️ Менторская гостиная на «Созидателях»',
  'Возможность задать вопросы экспертам, включая Анну Жигульскую из Росатома. Приём заявок открыт до 10 ноября.',
  '<p><strong>⚡️ Менторская гостиная на «Созидателях»</strong> — отличная возможность задать свой вопрос и получить конкретные ответы от экспертов.</p><p><a href="https://t.me/rosmolodez_predprinimay/13838" style="color: #1e88e5; text-decoration: none; font-weight: bold;">Узнать подробнее о мероприятии</a></p><p>В числе спикеров — <strong>Анна Жигульская</strong>, директор проектного офиса по внутренним коммуникациям и КСО Госкорпорации «Росатом».</p><p><strong>Не упустите шанс получить личные инсайты и практические советы! ⬇️</strong></p><p><a href="http://clck.ru/3PLhyZ" style="color: #e91e63; text-decoration: none; font-weight: bold; font-size: 18px;">Подать заявку на участие</a></p><p style="color: #ff5722; font-weight: bold;">Приём заявок открыт до 10 ноября!</p><p>👌 <a href="https://t.me/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Подписывайтесь на «Энергию Развития»</a> | <a href="https://t.me/boost/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Оставляйте «бусты»</a></p><p style="color: #666; font-size: 14px;">#мероприятие</p>',
  'THEME',
  NOW()
);

-- Новость 3: «Энергия городов» в Железногорске
INSERT INTO news (user_id, npo_id, volunteer_id, admin_id, name, annotation, text, type, created_at)
VALUES (
  (SELECT id FROM users WHERE login = 'admin'),
  NULL,
  NULL,
  (SELECT id FROM users WHERE login = 'admin'),
  '⚡️ «Энергия городов» дождь не помеха!',
  'Новый выпуск из Железногорска: секретное предприятие в скале, кукольный театр, встреча с хаски и горнолыжный склон. Премьера 8 ноября.',
  '<p><strong>⚡️ «Энергии городов» дождь не помеха!</strong> Встречайте по-настоящему осенний выпуск из уютного Железногорска.</p><p>Нас ждет <strong>секретное предприятие внутри скалы!</strong> Выберем себе профессию из числа специальностей Горно-химического комбината.</p><p>Побываем в закулисье лампового кукольного театра, посетим квиз в библиотеке, отдохнем в шикарном санатории-профилактории «Юбилейный» и пообщаемся с лошадями и милыми хаски. А еще — посмотрим на местный горнолыжный склон и загадаем вернуться зимой, чтобы покататься!</p><p style="color: #e91e63; font-weight: bold; font-size: 18px;">❗️Премьера нового выпуска «Энергии городов»</p><p><a href="https://vkvideo.ru/playlist/-172285001_12" style="color: #1e88e5; text-decoration: none; font-weight: bold;">Смотреть выпуск</a></p><p><strong>📅 Суббота, 8 ноября<br>🕛 12:00 по московскому времени</strong></p><p>👌 <a href="https://t.me/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Подписывайтесь на «Энергию Развития»</a> | <a href="https://t.me/boost/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Оставляйте «бусты»</a></p><p style="color: #666; font-size: 14px;">#ЭнергияГородов</p>',
  'THEME',
  NOW()
);

-- Новость 4: Атомщики спасают малышей нерп и тюленей
INSERT INTO news (user_id, npo_id, volunteer_id, admin_id, name, annotation, text, type, created_at)
VALUES (
  (SELECT id FROM users WHERE login = 'admin'),
  NULL,
  NULL,
  (SELECT id FROM users WHERE login = 'admin'),
  '❤️ Атомщики спасают малышей нерп и тюленей',
  'Сотрудники Ленинградской АЭС вместе с Фондом друзей балтийской нерпы помогают выхаживать детенышей морских обитателей на побережье Финского залива.',
  '<p><strong>❤️ Атомщики спасают малышей нерп и тюленей</strong></p><p>На побережье Финского залива сотрудники <a href="https://t.me/laesinfo" style="color: #1e88e5; text-decoration: none;"><strong>Ленинградской атомной станции</strong></a> вместе с <a href="https://t.me/s/sealresque" style="color: #1e88e5; text-decoration: none;"><strong>Фондом друзей балтийской нерпы</strong></a> помогают маленьким морским обитателям, оказавшимся в беде.</p><p>Каждый год в этом регионе на берег выбрасываются ослабленные детёныши нерп и тюленей — без помощи человека им не выжить. Благодаря заботе волонтёров и специалистов, малышей выхаживают, кормят, а затем выпускают обратно в море.</p><p>Эта добрая миссия — часть большой работы по сохранению природы и биоразнообразия. Ведь забота об окружающем мире начинается с простых дел и искреннего участия 💙</p><p><a href="https://dobro.press/dobro-media/story/baltijskie-pushistiki?utm_source=vk&utm_medium=dobropress&utm_campaign=baltijskie-pushistiki" style="color: #e91e63; text-decoration: none; font-weight: bold;">↖️ Подробнее о том, как атомщики помогают морским животным, читайте в материале наших коллег из Добро.Медиа</a></p><p>👌 <a href="https://t.me/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Подписывайтесь на «Энергию Развития»</a> | <a href="https://t.me/boost/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Оставляйте «бусты»</a></p><p style="color: #666; font-size: 14px;">#добро #ДоброМедиа</p>',
  'THEME',
  NOW()
);

-- Новость 5: День народного единства
INSERT INTO news (user_id, npo_id, volunteer_id, admin_id, name, annotation, text, type, created_at)
VALUES (
  (SELECT id FROM users WHERE login = 'admin'),
  NULL,
  NULL,
  (SELECT id FROM users WHERE login = 'admin'),
  'Когда «Я» и «Ты» становятся «МЫ»',
  '4 ноября отмечаем День народного единства — праздник, напоминающий о силе поддержки и умении быть вместе. Что единство значит для вас?',
  '<p><strong>Когда «Я» и «Ты» становятся «МЫ»</strong></p><p>Сегодня, <strong>4 ноября</strong>, мы отмечаем <strong>День народного единства</strong> — праздник, который напоминает: сила нашей страны в людях, в поддержке и в умении быть вместе.</p><p>Быть едиными — значит помогать, вдохновлять, создавать и верить друг в друга. Из множества разных «я» рождается одно большое «мы» — то, что делает нас сильнее, теплее и ближе.</p><p><strong>А что для вас значит единство?</strong><br>Поделитесь своими мыслями в комментариях ⏬</p><p>👌 <a href="https://t.me/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Подписывайтесь на «Энергию Развития»</a> | <a href="https://t.me/boost/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Оставляйте «бусты»</a></p><p style="color: #666; font-size: 14px;">#праздник</p>',
  'THEME',
  NOW()
);

-- Новость 6: Росатом на Форуме БРИКС 2025
INSERT INTO news (user_id, npo_id, volunteer_id, admin_id, name, annotation, text, type, created_at)
VALUES (
  (SELECT id FROM users WHERE login = 'admin'),
  NULL,
  NULL,
  (SELECT id FROM users WHERE login = 'admin'),
  '⚡️ Госкорпорация «Росатом» на Международном муниципальном форуме БРИКС 2025',
  'Участие в обсуждении устойчивого развития, социального предпринимательства и волонтерства. Представлены программы «Люди и города» и «Гостеприимные города».',
  '<p><strong>⚡️ Госкорпорация «Росатом» приняла участие в Международном муниципальном форуме БРИКС 2025</strong></p><p>Форум в Санкт-Петербурге стал площадкой для обсуждения устойчивого развития, партнёрства и социальных инициатив.</p><p><strong>Генеральный директор АНО «Энергия Развития» Ольга Шкабардня</strong> выступила на секции «Социально-ответственное предпринимательство», где рассказала о подходах к развитию социального предпринимательства и представила программу «Люди и города».</p><p>В рамках <strong>Международного волонтёрского хаба</strong> прошли две сессии, в которых приняли участие <strong>Екатерина Жуковская</strong> — руководитель направления международного сотрудничества АНО «Энергия Развития» и <strong>Ольга Шкабардня</strong> — генеральный директор АНО «Энергия Развития». Участники обсудили международные практики добровольчества, взаимодействие государства, бизнеса и общества, а также практики Госкорпорации в реализации социальных проектов.</p><p>Кроме того, представители Росатома приняли участие в секциях <strong>«КРТ 2.0 — инструмент устойчивого развития»</strong> и <strong>«Гостеприимные города»</strong>, где говорили о развитии городской среды и превращении атомных городов в центры туризма и событийной экономики.</p><p style="color: #1e88e5; font-weight: bold;">↗️ Форум БРИКС объединил участников из разных стран, став пространством для обмена идеями, практиками и новыми проектами в сфере устойчивого развития.</p><p>👌 <a href="https://t.me/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Подписывайтесь на «Энергию Развития»</a> | <a href="https://t.me/boost/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Оставляйте «бусты»</a></p><p style="color: #666; font-size: 14px;">#ФорумБРИКС #новости</p>',
  'THEME',
  NOW()
);

-- Новость 7: Октябрьский дайджест атомных городов
INSERT INTO news (user_id, npo_id, volunteer_id, admin_id, name, annotation, text, type, created_at)
VALUES (
  (SELECT id FROM users WHERE login = 'admin'),
  NULL,
  NULL,
  (SELECT id FROM users WHERE login = 'admin'),
  '⚡️ События, которые объединяют: октябрьский дайджест атомных городов',
  'Новый выпуск дайджеста: голосование за финалистов #МЫВМЕСТЕ, фестиваль #5верст, «Бумеранг добра», «Арт-экология» и другие события атомных городов.',
  '<p><strong>⚡️ События, которые объединяют: октябрьский дайджест атомных городов</strong></p><p>Представляем новый выпуск нашего отраслевого дайджеста!</p><p><strong>Что внутри?</strong></p><p>🟦 Международное голосование за «атомных» финалистов премии #МЫВМЕСТЕ</p><p>🟦 Фестиваль бега и ходьбы #5верст в Зеленогорске</p><p>🟦 «Бумеранг добра» в Глазове</p><p>🟦 «Арт-экология» в пензенском Заречном</p><p>🟦 «Тур возможностей» на Чукотке</p><p>🟦 Итоги «Атомслета-2025» — и многое другое!</p><p><a href="http://vk.cc/cQUhAc" style="color: #e91e63; text-decoration: none; font-weight: bold;">👆 Читать полностью</a></p><p><strong>Ждём ваши новости</strong> в любую из рубрик следующего выпуска в свободной форме до понедельника, 24 ноября, на почту <a href="mailto:energiarazvitiya@yandex.ru" style="color: #1e88e5; text-decoration: none;">energiarazvitiya@yandex.ru</a></p><p><em>Атомные города создают добрые истории вместе — присоединяйтесь и вы!</em></p><p>👌 <a href="https://t.me/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Подписывайтесь на «Энергию Развития»</a> | <a href="https://t.me/boost/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Оставляйте «бусты»</a></p><p style="color: #666; font-size: 14px;">#дайджест</p>',
  'THEME',
  NOW()
);

-- Новость 8: Сосновый Бор в «Энергии городов»
INSERT INTO news (user_id, npo_id, volunteer_id, admin_id, name, annotation, text, type, created_at)
VALUES (
  (SELECT id FROM users WHERE login = 'admin'),
  NULL,
  NULL,
  (SELECT id FROM users WHERE login = 'admin'),
  'Юный, зелёный, активный — Сосновый Бор встречает «Энергию городов»!',
  'Новый выпуск из Соснового Бора: картинг, поисковый отряд, сказки Андерсена, лаборатории для атомщиков и встречи с молодыми специалистами ЛАЭС.',
  '<p><strong>Юный, зелёный, активный — Сосновый Бор встречает «Энергию городов»!</strong></p><p>Впереди — дух соревнования на картинге, поисковый отряд и путешествие по сказкам Андерсена.</p><p>Мы посетим местный пляж и парки, мастерские и лаборатории для будущих атомщиков. Попробуем разные виды спорта — от классических до восточных единоборств. А ещё пообщаемся с молодыми специалистами Ленинградской АЭС, которые однажды влюбились в этот город и остались здесь жить.</p><p><a href="https://vk.com/video-172285001_456239409" style="color: #e91e63; text-decoration: none; font-weight: bold;">Присоединяйтесь! Смотрим премьеру здесь</a></p><p><em>Госкорпорация «Росатом» представляет серию фильмов «Энергия городов». От Калининградской области до Чукотки — в каждом выпуске наша съёмочная группа отправляется в один из атомградов России.</em></p><p>👌 <a href="https://t.me/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Подписывайтесь на «Энергию Развития»</a> | <a href="https://t.me/boost/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Оставляйте «бусты»</a></p><p style="color: #666; font-size: 14px;">#ЭнергияГородов #ГостеприимныеГородаРосатома</p>',
  'THEME',
  NOW()
);

-- Новость 9: Новый выпуск подкаста с Владимиром Вайнером
INSERT INTO news (user_id, npo_id, volunteer_id, admin_id, name, annotation, text, type, created_at)
VALUES (
  (SELECT id FROM users WHERE login = 'admin'),
  NULL,
  NULL,
  (SELECT id FROM users WHERE login = 'admin'),
  '🎙 Новый выпуск подкаста «Добро без галстуков» с Владимиром Вайнером',
  'Руководитель развития НКО АСИ рассказал о роли некоммерческих организаций как акторов изменений и социальных инноваций.',
  '<p><strong>🎙 Новый выпуск подкаста «Добро без галстуков»</strong></p><p>Гость студии — <strong>Владимир Вайнер</strong>, руководитель развития некоммерческих организаций <a href="https://t.me/ASI_RU" style="color: #1e88e5; text-decoration: none;"><strong>Агентства стратегических инициатив</strong></a>.</p><p><em>«Некоммерческие организации — это акторы изменений. Именно они находят социальные инновации, которые потом подхватывает бизнес и масштабирует государство»</em>, — делится Владимир.</p><p>Владимир расскажет, почему именно некоммерческие организации первыми замечают, где нужны перемены, как волонтёрские инициативы превращаются в национальные проекты и почему в этой сфере нет права на ошибку.</p><p><a href="https://vk.com/video-232477963_456239036" style="color: #e91e63; text-decoration: none; font-weight: bold;">Смотрим выпуск здесь 👆</a></p><p><strong>Новости создателей проекта:</strong></p><p>🔵 <a href="https://t.me/corpvolunteers" style="color: #1e88e5; text-decoration: none;">канал Национального совета по корпоративному волонтерству (НСКВ) в Telegram</a></p><p>🔵 <a href="https://vk.com/rosatomdobro" style="color: #1e88e5; text-decoration: none;">сообщество АНО «Энергия развития» в ВК</a></p><p><a href="https://vk.com/dobro_bez_galstukov" style="color: #1e88e5; text-decoration: none; font-weight: bold;">Подписывайтесь на официальное сообщество проекта в ВК!</a></p><p>👌 <a href="https://t.me/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Подписывайтесь на «Энергию Развития»</a> | <a href="https://t.me/boost/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Оставляйте «бусты»</a></p><p style="color: #666; font-size: 14px;">#ДоброБезГалстуков</p>',
  'THEME',
  NOW()
);

-- Новость 10: Поддержка проектов Росатома в премии #МЫВМЕСТЕ
INSERT INTO news (user_id, npo_id, volunteer_id, admin_id, name, annotation, text, type, created_at)
VALUES (
  (SELECT id FROM users WHERE login = 'admin'),
  NULL,
  NULL,
  (SELECT id FROM users WHERE login = 'admin'),
  'Поддержим проекты Росатома в финале Международной премии #МЫВМЕСТЕ',
  'Смоленская АЭС, волонтер Денис Лукиных и город Глазов — финалисты премии. Голосование открыто до 7 ноября.',
  '<p><strong>Поддержим проекты Росатома в финале Международной премии <a href="https://t.me/myvmesteawards" style="color: #1e88e5; text-decoration: none;">#МЫВМЕСТЕ</a></strong></p><p>В числе финалистов — <strong>Смоленская АЭС</strong>, волонтёр ФГУП «Радон» <strong>Денис Лукиных</strong> и город <strong>Глазов</strong>. Каждый из них — часть большой атомной семьи, которая делает добро и вдохновляет других!</p><div style="background: #f5f5f5; padding: 15px; border-radius: 8px; margin: 10px 0;"><p>🔵 <strong>Смоленская атомная станция</strong> — проект «Автографы Победы»<br><em>Номинация:</em> «Лидер социальных изменений. Крупный бизнес»<br><em>Регион:</em> Смоленская область<br><em>ID заявки:</em> 398859<br><a href="https://vk.com/smolensknpp" style="color: #1e88e5; text-decoration: none;">Подробнее о проекте</a></p></div><div style="background: #f5f5f5; padding: 15px; border-radius: 8px; margin: 10px 0;"><p>🔵 <strong>Денис Лукиных</strong> — проект «Цех 52»<br><em>Номинация:</em> «Герои нашего времени»<br><em>Регион:</em> Нижегородская область<br><em>ID заявки:</em> 387664<br><a href="https://vk.com/ceh52volonter" style="color: #1e88e5; text-decoration: none;">Подробнее о проекте</a></p></div><div style="background: #f5f5f5; padding: 15px; border-radius: 8px; margin: 10px 0;"><p>🔵 <strong>Город Глазов</strong> — финалист трека «Территория»<br><em>Номинация:</em> «Муниципальные образования и моногорода»<br><em>Регион:</em> Удмуртская Республика<br><em>ID заявки:</em> 424406</p></div><p>Давайте вместе поддержим наших участников и покажем, что атомные города и инициативы Росатома делают мир добрее и сильнее! 💙</p><p style="color: #e91e63; font-weight: bold; font-size: 16px;">❗️ Голосование открыто до 7 ноября включительно.</p><p><a href="http://trk.mail.ru/c/jbgqa5" style="color: #1e88e5; text-decoration: none; font-weight: bold;">Принять участие в голосовании</a><br><a href="https://vk.cc/cQQ9mD" style="color: #666; text-decoration: none;">Пошаговая инструкция по голосованию</a></p><p>👌 <a href="https://t.me/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Подписывайтесь на «Энергию Развития»</a> | <a href="https://t.me/boost/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Оставляйте «бусты»</a></p><p style="color: #666; font-size: 14px;">#ПремияМЫВМЕСТЕ #голосование</p>',
  'THEME',
  NOW()
);

-- Новость 11: «Дорогами двух Великих Побед»
INSERT INTO news (user_id, npo_id, volunteer_id, admin_id, name, annotation, text, type, created_at)
VALUES (
  (SELECT id FROM users WHERE login = 'admin'),
  NULL,
  NULL,
  (SELECT id FROM users WHERE login = 'admin'),
  '«Дорогами двух Великих Побед»: оживляем воспоминания',
  'Участники тура посетили Кольскую АЭС, атомный ледокол «Ленин» и мемориал «Долина Славы». Смотрите видео о путешествии.',
  '<p><strong>«Дорогами двух Великих Побед»: оживляем воспоминания — смотрим видео! ↖️</strong></p><p>Во время поездки участники:</p><p>🔵 посетили <strong>Кольскую АЭС</strong> — первую атомную станцию за Полярным кругом</p><p>🔵 увидели легендарный первый в мире атомный ледокол <strong>«Ленин»</strong> — это точно произвело сильное впечатление! 🚢</p><p>🔵 почтили память героев в мемориальном комплексе <strong>«Долина Славы»</strong>.</p><p><a href="https://vk.com/video-172285001_456239433" style="color: #e91e63; text-decoration: none; font-weight: bold;">Смотрите видео, чтобы окунуться в атмосферу тура и увидеть самые яркие моменты!</a></p><p>🔔 <a href="http://t.me/visit_atom" style="color: #1e88e5; text-decoration: none;"><strong>Подписывайтесь на канал «Гостеприимные города Росатома»</strong></a>, чтобы первыми узнавать о турах и скрытых сокровищах атомных городов!</p><p style="color: #666; font-size: 14px;">Проект реализуется госкорпорацией «Росатом» совместно с программой «Больше, чем путешествие» Федерального агентства по делам молодежи («Росмолодёжь») и Министерством науки и высшего образования России.</p><p>👌 <a href="https://t.me/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Подписывайтесь на «Энергию Развития»</a> | <a href="https://t.me/boost/rosatomdobro" style="color: #1e88e5; text-decoration: none;">Оставляйте «бусты»</a></p><p style="color: #666; font-size: 14px;">#ГостеприимныеГородаРосатома</p>',
  'THEME',
  NOW()
);
...
VALUES (
  ...
  '<p>Регистрация некоммерческой организации (НКО) — важный шаг для создания юридического лица, которое будет заниматься социально значимой деятельностью.</p><p><strong>Шаг 1: Выбор организационно-правовой формы</strong><br>- Автономная некоммерческая организация (АНО)<br>- Фонд<br>- Общественная организация<br>- Ассоциация (союз)</p><p><strong>Шаг 2: Подготовка документов</strong><br>- Устав организации<br>- Протокол учредительного собрания<br>- Заявление по форме РН0001<br>- Квитанция об уплате госпошлины (4000 рублей)</p><p><strong>Шаг 3: Подача документов в Минюст</strong><br>Документы подаются в территориальный орган Министерства юстиции РФ по месту нахождения организации.</p><p><strong>Шаг 4: Получение документов</strong><br>После проверки документов (срок до 30 дней) вы получите решение о регистрации и сможете забрать документы в Минюсте.</p><p><strong>Шаг 5: Постановка на учет в налоговой</strong><br>После регистрации необходимо встать на учет в налоговой инспекции и получить ИНН и ОГРН.</p>',
...
VALUES (
  ...
  '<p>Эффективное управление НКО требует понимания специфики работы некоммерческого сектора и соблюдения законодательных требований.</p><p><strong>Органы управления НКО:</strong><br>1. Высший орган управления (общее собрание, конференция)<br>2. Постоянно действующий коллегиальный орган (совет, правление)<br>3. Единоличный исполнительный орган (директор, председатель)</p><p><strong>Основные обязанности руководства:</strong><br>- Разработка стратегии развития организации<br>- Планирование деятельности и бюджета<br>- Контроль за выполнением уставных целей<br>- Взаимодействие с государственными органами<br>- Отчетность перед учредителями и контролирующими органами</p><p><strong>Финансовая отчетность:</strong><br>НКО обязаны вести бухгалтерский учет и представлять отчетность в соответствии с требованиями законодательства. Ежегодно необходимо подавать отчет о деятельности в Минюст.</p><p><strong>Работа с волонтерами:</strong><br>Привлечение и координация волонтеров — важная часть работы многих НКО. Необходимо правильно оформлять отношения с волонтерами, обеспечивать их безопасность и мотивацию.</p>',
  NOW()
);
...
VALUES (
  ...
  '<p>Видео-лекция из курса «НКО: от идеи до реализации» на тему "Что именно мы предлагаем?".</p><p>В этом материале рассматриваются вопросы формирования продуктов и услуг НКО:</p><p>- Определение продуктов и услуг организации<br>- Уникальное ценностное предложение НКО<br>- Разработка программ и проектов<br>- Позиционирование организации на рынке социальных услуг</p><p>Материал поможет НКО четко сформулировать, что именно они предлагают своим благополучателям и партнерам.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция из курса «НКО: от идеи до реализации» на тему "Где найти деньги на мою НКО: базовый фандрайзинг".</p><p><strong>Спикер:</strong> Анастасия Москвина</p><p>В этом материале рассматриваются основы фандрайзинга для НКО:</p><p>- Основные источники финансирования НКО<br>- Стратегии привлечения средств<br>- Работа с донорами и спонсорами<br>- Краудфандинг и другие современные инструменты<br>- Планирование фандрайзинговой кампании</p><p>Материал поможет НКО освоить базовые навыки привлечения финансирования для своей деятельности.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция из курса «НКО: от идеи до реализации» на тему "Как написать/улучшить грантовую заявку? Где искать гранты?".</p><p>В этом материале рассматриваются практические аспекты работы с грантами:</p><p>- Где искать информацию о грантах и конкурсах<br>- Структура и требования грантовой заявки<br>- Как правильно описать проект и его цели<br>- Бюджет проекта и обоснование расходов<br>- Типичные ошибки при написании заявок<br>- Как улучшить уже поданную заявку</p><p>Материал поможет НКО повысить шансы на получение грантового финансирования.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция из курса «НКО: от идеи до реализации» на тему "Социальное предпринимательство в НКО: Кто купит мой продукт? Портрет клиента".</p><p>В этом материале рассматриваются основы социального предпринимательства:</p><p>- Понятие социального предпринимательства в НКО<br>- Определение целевой аудитории и портрета клиента<br>- Сегментация рынка социальных услуг<br>- Исследование потребностей целевой группы<br>- Разработка продуктов и услуг под потребности клиентов<br>- Монетизация социальных проектов</p><p>Материал поможет НКО развивать предпринимательские подходы и создавать устойчивые бизнес-модели.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Основные задачи PR: Что важно для успешного развития организации?".</p><p><strong>Спикер:</strong> Анастасия Андронова</p><p>В этом материале рассматриваются ключевые аспекты PR-деятельности для НКО:</p><p>- Основные задачи PR в некоммерческом секторе<br>- Построение репутации организации<br>- Работа с медиа и общественностью<br>- Коммуникационные стратегии для НКО<br>- Инструменты и методы PR-продвижения</p><p>Материал поможет НКО понять важность PR-деятельности и использовать ее для успешного развития организации.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Организация мероприятий и их PR-поддержка".</p><p>В этом материале рассматриваются практические аспекты организации мероприятий и их продвижения:</p><p>- Планирование и организация мероприятий НКО<br>- PR-стратегия для мероприятий<br>- Привлечение внимания к событию<br>- Работа со СМИ и партнерами<br>- Измерение эффективности PR-кампании мероприятия</p><p>Материал поможет НКО эффективно организовывать мероприятия и привлекать к ним внимание целевой аудитории.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Взаимосвязь PR и GR в построении узнаваемого бренда".</p><p>В этом материале рассматриваются вопросы построения бренда НКО через интеграцию PR и GR:</p><p>- Понятие PR (Public Relations) и GR (Government Relations)<br>- Взаимосвязь между PR и GR в работе НКО<br>- Построение узнаваемого бренда организации<br>- Работа с государственными структурами<br>- Комплексный подход к коммуникациям</p><p>Материал поможет НКО выстроить эффективную систему коммуникаций с различными стейкхолдерами.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Команда НКО: От набора людей к сильному коллективу".</p><p><strong>Спикер:</strong> Алексей Мокеев</p><p>В этом материале рассматриваются вопросы формирования и развития команды в НКО:</p><p>- Процесс подбора и найма сотрудников<br>- Формирование команды из отдельных людей<br>- Создание корпоративной культуры<br>- Мотивация и вовлеченность команды<br>- Превращение группы людей в эффективный коллектив</p><p>Материал поможет НКО построить сильную и сплоченную команду для достижения целей организации.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Управление командой: Инструменты руководителя НКО, стили управления в НКО, делегирование и контроль, выстраивание процессов коммуникации".</p><p>В этом материале рассматриваются практические инструменты управления командой в НКО:</p><p>- Инструменты и методы управления командой<br>- Стили управления и их применение в НКО<br>- Делегирование задач и полномочий<br>- Контроль выполнения задач<br>- Выстраивание эффективных процессов коммуникации в команде</p><p>Материал поможет руководителям НКО эффективно управлять командой и достигать поставленных целей.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Развитие и удержание команды в долгосрочной перспективе".</p><p>В этом материале рассматриваются стратегии долгосрочного развития и удержания команды:</p><p>- Планирование развития команды на перспективу<br>- Программы обучения и развития сотрудников<br>- Системы мотивации и удержания персонала<br>- Создание условий для профессионального роста<br>- Работа с текучестью кадров</p><p>Материал поможет НКО создать условия для долгосрочного развития и удержания ценных сотрудников.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Зелёный офис — Концепция «Зелёный офис». С чего начать?".</p><p><strong>Спикеры:</strong> Ольга Шкабардня, Евгения Кузнецова</p><p>В этом материале рассматриваются основы концепции "Зелёный офис":</p><p>- Понятие и принципы "Зелёного офиса"<br>- С чего начать внедрение экологических практик в офисе<br>- Основные направления экологизации офисного пространства<br>- Экономические и экологические преимущества<br>- Первые шаги для организации</p><p>Материал поможет организациям начать путь к созданию экологически ответственного офисного пространства.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Зелёный офис: от слов к делу".</p><p><strong>Спикер:</strong> Ксения Лопаткина</p><p>В этом материале рассматриваются практические шаги по реализации концепции "Зелёный офис":</p><p>- Переход от планирования к реализации<br>- Конкретные действия и инициативы<br>- Преодоление барьеров при внедрении<br>- Измерение результатов<br>- Лучшие практики и кейсы</p><p>Материал поможет организациям перейти от теоретического понимания к практической реализации экологических инициатив в офисе.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Как привлекать и вовлекать сотрудников в инициативы «зеленого» офиса компании".</p><p><strong>Спикер:</strong> Александра Лавренко</p><p>В этом материале рассматриваются методы вовлечения сотрудников в экологические инициативы:</p><p>- Стратегии привлечения сотрудников к экологическим проектам<br>- Методы мотивации и вовлечения<br>- Создание экологической культуры в организации<br>- Коммуникация экологических инициатив<br>- Преодоление сопротивления изменениям</p><p>Материал поможет организациям эффективно вовлекать сотрудников в экологические инициативы и создавать устойчивую экологическую культуру.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Путь от возникновения идеи до получения локальных и глобальных результатов".</p><p><strong>Спикер:</strong> Юрий Калашников</p><p>В этом материале рассматривается процесс реализации экологических инициатив от идеи до результатов:</p><p>- От идеи к реализации проекта<br>- Планирование и этапы внедрения<br>- Достижение локальных результатов<br>- Масштабирование и глобальные эффекты<br>- Измерение и оценка результатов</p><p>Материал поможет организациям понять полный цикл реализации экологических проектов и достичь значимых результатов.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Вовлечение сотрудников в концепцию «Зеленого офиса»".</p><p><strong>Спикер:</strong> Екатерина Тышковская</p><p>В этом материале рассматриваются практические подходы к вовлечению сотрудников:</p><p>- Методы вовлечения сотрудников в экологические практики<br>- Создание мотивации для участия<br>- Образовательные программы и тренинги<br>- Создание сообщества единомышленников<br>- Измерение уровня вовлеченности</p><p>Материал поможет организациям создать активное сообщество сотрудников, вовлеченных в экологические инициативы.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Подведение итогов курса. Ответы на часто задаваемые вопросы".</p><p><strong>Спикер:</strong> Юрий Калашников</p><p>В этом материале подводятся итоги курса по "Зелёному офису" и даются ответы на часто задаваемые вопросы:</p><p>- Ключевые выводы и рекомендации курса<br>- Ответы на популярные вопросы участников<br>- Типичные ошибки и как их избежать<br>- Дополнительные ресурсы и материалы<br>- Следующие шаги для развития</p><p>Материал поможет закрепить полученные знания и найти ответы на практические вопросы по внедрению концепции "Зелёный офис".</p>',
...
VALUES (
  ...
  '<p>Видео-лекция из курса «Университет волонтёра» на тему "Развитие городов".</p><p><strong>Спикер:</strong> Ольга Вовк</p><p>В этом материале рассматриваются вопросы развития городов через волонтёрскую деятельность:</p><p>- Роль волонтёров в развитии городской среды<br>- Социальные проекты для развития городов<br>- Взаимодействие с городскими властями и сообществами<br>- Устойчивое развитие городской среды<br>- Лучшие практики городских волонтёрских инициатив</p><p>Материал поможет волонтёрам и НКО понять, как их деятельность может способствовать развитию городов.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Нормы социального проектирования проектов и лучшая практика КСО-проектов".</p><p><strong>Спикер:</strong> Алексей Журавлев</p><p>В этом материале рассматриваются стандарты и практики социального проектирования:</p><p>- Нормы и стандарты социального проектирования<br>- Лучшие практики корпоративной социальной ответственности (КСО)<br>- Проектирование социально значимых проектов<br>- Методологии и подходы к социальному проектированию<br>- Кейсы успешных КСО-проектов</p><p>Материал поможет организациям создавать эффективные социальные проекты в соответствии с лучшими практиками.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Оценка эффективности КСО-проектов".</p><p><strong>Спикер:</strong> Жак Загидуллин</p><p>В этом материале рассматриваются методы оценки эффективности корпоративных социальных проектов:</p><p>- Методологии оценки эффективности КСО-проектов<br>- Ключевые показатели эффективности (KPI)<br>- Измерение социального воздействия<br>- Оценка экономической эффективности<br>- Отчетность и коммуникация результатов</p><p>Материал поможет организациям правильно оценивать эффективность своих социальных проектов и демонстрировать их ценность.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Как создать своё сообщество".</p><p><strong>Спикеры:</strong> Юрий Калашников, Ася Репрева</p><p>В этом материале рассматриваются практические аспекты создания сообщества:</p><p>- Основы создания сообщества вокруг проекта или идеи<br>- Построение структуры и правил сообщества<br>- Привлечение первых участников<br>- Создание ценности для участников сообщества<br>- Развитие и масштабирование сообщества</p><p>Материал поможет создать активное и вовлеченное сообщество единомышленников.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Как собрать вокруг себя единомышленников и расширить целевую аудиторию".</p><p><strong>Спикер:</strong> Ася Репрева</p><p>В этом материале рассматриваются стратегии привлечения единомышленников и расширения аудитории:</p><p>- Методы поиска и привлечения единомышленников<br>- Расширение целевой аудитории проекта<br>- Коммуникационные стратегии для привлечения новых участников<br>- Работа с существующей аудиторией для привлечения новых<br>- Инструменты и платформы для расширения сообщества</p><p>Материал поможет эффективно расширять аудиторию и находить единомышленников для своего проекта.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Социальные экостартапы: может ли волонтерский проект стать бизнес-проектом".</p><p><strong>Спикер:</strong> Сергей Тушев</p><p>В этом материале рассматриваются возможности трансформации волонтерских проектов в бизнес:</p><p>- Переход от волонтерского проекта к социальному бизнесу<br>- Особенности социальных экостартапов<br>- Бизнес-модели для социальных проектов<br>- Монетизация экологических инициатив<br>- Преодоление барьеров при трансформации проекта</p><p>Материал поможет понять, как волонтерский проект может стать устойчивым бизнес-проектом.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Подготовка к питчингу".</p><p><strong>Спикер:</strong> Игорь Померанцев</p><p>В этом материале рассматриваются аспекты подготовки к питчингу проекта:</p><p>- Что такое питчинг и его цели<br>- Структура успешной презентации проекта<br>- Подготовка выступления и репетиция<br>- Работа с аудиторией и ответы на вопросы<br>- Типичные ошибки при питчинге и как их избежать</p><p>Материал поможет эффективно подготовиться к презентации проекта перед инвесторами, донорами или жюри конкурса.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция из «Школы социального проектирования» на тему "Какие тренды социального проектирования актуальны?".</p><p><strong>Спикер:</strong> Евгения Николаева</p><p>В этом материале рассматриваются актуальные тренды в социальном проектировании:</p><p>- Современные тренды социального проектирования<br>- Новые подходы и методологии<br>- Инновации в социальной сфере<br>- Адаптация проектов под современные вызовы<br>- Будущее социального проектирования</p><p>Материал поможет быть в курсе актуальных трендов и применять их в своих проектах.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Практика: ищем идеи проекта".</p><p><strong>Спикер:</strong> Евгения Николаева</p><p>В этом материале рассматриваются практические методы поиска идей для социальных проектов:</p><p>- Методы генерации идей для проектов<br>- Анализ потребностей целевой аудитории<br>- Выявление социальных проблем и их решений<br>- Техники креативного мышления<br>- От идеи к концепции проекта</p><p>Материал поможет найти вдохновение и сформировать идею для социального проекта.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Как собрать команду мечты?".</p><p><strong>Спикер:</strong> Ани Кочарян</p><p>В этом материале рассматриваются стратегии формирования идеальной команды:</p><p>- Поиск и подбор подходящих людей<br>- Определение ролей и компетенций в команде<br>- Создание синергии в команде<br>- Мотивация и удержание талантов<br>- Построение эффективных рабочих отношений</p><p>Материал поможет собрать команду, которая будет эффективно работать над достижением целей проекта.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Как выстраивать отношения с ЦА в социальных сетях?".</p><p><strong>Спикер:</strong> Шанаева Ирина</p><p>В этом материале рассматриваются стратегии построения отношений с целевой аудиторией в социальных сетях:</p><p>- Понимание целевой аудитории в соцсетях<br>- Стратегии взаимодействия с аудиторией<br>- Создание доверия и лояльности<br>- Работа с комментариями и обратной связью<br>- Построение долгосрочных отношений</p><p>Материал поможет эффективно выстраивать отношения с целевой аудиторией через социальные сети.</p>',
...
VALUES (
  ...
  '<p>Видео-лекция на тему "Как вести социальные сети вашего проекта?".</p><p><strong>Спикер:</strong> Шанаева Ирина</p><p>В этом материале рассматриваются практические аспекты ведения социальных сетей проекта:</p><p>- Стратегия контента для социальных сетей<br>- Планирование публикаций и контент-план<br>- Создание визуального контента<br>- Аналитика и измерение эффективности<br>- Инструменты для управления социальными сетями</p><p>Материал поможет эффективно вести социальные сети проекта и привлекать внимание целевой аудитории.</p>',
